...
\smallskip
\small Notes: All entries are regime means. Interest in euros is reported in million euros. The ten-year yield is excluded from the printed table to keep the regime table readable; its regime means are discussed in text.
\end{table}
