...
\smallskip
\small Notes: Burdens are percent of GDP; effects and errors are percentage points. Effects are shown to three decimals so that the two components add to the displayed total. The decomposition uses unrounded nominal interest, debt, and GDP. Source: author calculations from Eurostat data.
\end{table}
