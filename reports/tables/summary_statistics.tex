...
\smallskip
\small Notes: Observed Eurostat ESA 2010 Portugal rows only. The average-debt rate uses average debt. Interest is general-government interest payable. Where an extreme is attained in more than one year, every year is listed.
\end{table}
