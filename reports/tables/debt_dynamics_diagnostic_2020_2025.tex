...
\smallskip
\small Notes: $r^{AVG}$ is the average-debt rate and $r^{DD}$ the debt-dynamics rate. The first row uses the previous debt ratio available in the processed dataset. Source: author calculations from Eurostat data.
\end{table}
