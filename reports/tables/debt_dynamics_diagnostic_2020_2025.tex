...
\toprule
Year & Interest/GDP (\%) & Lagged debt/GDP (\%) & Nominal growth (\%) & $r^{AVG}$ (\%) & $r^{DD}$ (\%) & Interest-growth (pp) & Primary-balance contribution (pp) & Stock-flow (pp) & Observed $\Delta d$ (pp) & Rebuilt $\Delta d$ (pp) & Error (pp) \\
\midrule
