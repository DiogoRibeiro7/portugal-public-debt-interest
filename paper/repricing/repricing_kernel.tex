...
need not reset on the same schedule. Treating the whole non-fixed residual as a
single one-year, one-for-one reset block is therefore a scenario choice, and
the sensitivity table varies the timing leg of it. The
