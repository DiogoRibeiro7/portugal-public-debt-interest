...
the central behavioural effect set to zero. The sign is positive at the
reported horizons, but the table should be read as a bounded model exercise,
not as an identified empirical correction. The bias is a combination of an
early reset effect, a stylised contractual-shape effect, and behavioural bounds
reported separately.
